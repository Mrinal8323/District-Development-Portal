...
<form class="cat" action="problem1.php" method="post">
<input type="submit" name="name" value="Category 1">
</form>


<form class="cat" action="problem2.php" method="post">
<input type="submit" name="name" value="Category 2">
</form>

<form class="cat" action="problem3.php" method="post">
<input type="submit" name="name" value="Category 3">
</form>

<form class="cat" action="problem.php" method="post">
<input type="submit" name="name" value="All">
</form>
